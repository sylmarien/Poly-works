...
% On essaye toutes les combinaisons de lambda1 et lambda2
for l1=[0 0.01 0.1 1 10]
    for l2=[0 0.01 0.1 1 10]
...
%         save(['experiments/experimentElasticNet_taux' num2str(taux_dapprentissage,'%f') '_seuil' int2str(seuilConvergence) '.mat'...
%             '_lambda1-' num2str(lambda1, '%.4f') '_lambda2-' num2str(lambda2, '%.4f') '.mat'])
    end
end
